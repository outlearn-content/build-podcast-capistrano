...
<!-- @module, url: 'http://outlearn.com/rubyorg/ruby-console' -->

<!-- @asset, type: 'text/markdown, title: 'Overview' -->
...
<!-- @asset, type: 'text/markdown, title: 'Things to learn with Capistrano' -->
...
<!-- @asset, type: 'text/markdown, title: 'More Resources on Capistrano' -->
